...
const Home = () => {
  ...
  return (
    <Fragment>
        ...
        <div className="row py-5 shadow">
          <div className="col" data-aos="fade-right" data-aos-offset="300" data-aos-duration="500" data-aos-easing="ease-in-sine">
            <div className="d-flex flex-column gap-3 justify-content-center text-md-start text-center">
              ...
              <p className="fs-5 fw-bolder">It's easy to build a Website but it's hard to satisfy the client.</p>
              <p>VEM platform, understands the clients and their requirments.
                We are ready to fullfil all the needs that is essential to make a fully interactive and professional Ecommerce websites</p>
              <div className="">
                <Link to="/Signin">
      ...
      {/* ========================================================================================================= */}
      <section className="position-relative" style={{ color: `var(--text-color)` }}>
        <div className="position-absolute top-0 start-0 bottom-0 end-0" style={{ zIndex: '-2', overflow: 'hidden' }}>
          <img src={sImage} alt="" srcSet="" style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover'
          }} />
        </div>
        <div className="position-absolute top-0 start-0 bottom-0 end-0" style={{ backgroundColor: `var(--bg-color)`, zIndex: '-1', overflow: 'hidden', opacity: '0.7' }}></div>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"/>
  ...
  <div className="container pb-5">
      ...
      {/* ========================================================================================================= */}
      <div className="container">
        <h1 className="text-center pb-3">Our top rated shop</h1>
      </div>
