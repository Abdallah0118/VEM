...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8000/shop/myshop", {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  const handleDeleteSubmit = () => {
    axios
      .delete(`http://127.0.0.1:8000/shop/shopdetails/${shopInfo.id}/`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
            ...
            {userInfo ? (
              <>
                  ...
                  <img
                    src={
                      userInfo.profile_picture
                        ? `http://localhost:8000/${userInfo.profile_picture}`
                ...
                <div className="text-center p-1">
                  <h5 className="mt-2 mt-1">
                    {" "}
                    {userInfo.first_name} {userInfo.last_name}
                  </h5>
                  <span
                    className=".text-primary p-1 px-4 rounded "
                    style={{ display: userInfo.is_seller ? "inline" : "none" }}
                  >
                    Seller
                  </span>
                  <img
                    ...
                    width="30"
                    alt="quality"
                    style={{ display: userInfo.is_active ? "inline" : "none" }}
                  />
                ...
                <form>
                  ...
                  <div className="txt_field1">
                    <input
                      type="text"
                      value={userInfo.birth_date || "no birth date"}
                      readOnly
                    />
                    <span></span>
                  ...
                  <div className="txt_field1">
                    <input
                      type="text"
                      value={userInfo.location || "no location"}
                      readOnly
                    />
                    <span></span>
                  ...
                  <div className="card-body" key={shopInfo.id}>
                    <blockquote className="blockquote mb-0">
                      <div className="PhotoShop">
                        <img
                          src={
                            shopInfo.profile_image
                              ? `http://127.0.0.1:8000/${shopInfo.profile_image}`
                              : require("../assets/LogoShopClothes.png")
                          }
                          width={"100PX"}
                          alt="shopPhoto "
                      ...
                      <div className="bg" style={{ height: "220px" }}>
                        <img
                          src={
                            shopInfo.image
                              ? `http://127.0.0.1:8000/${shopInfo.image}`
                      ...
                      <Card.Title className="mt-5 font-weight-bold ">
                        <h2>{shopInfo.title}</h2>
                      </Card.Title>
                      <p>{shopInfo.details}</p>
                      <p className="blockquote-footer">
                        date start
                        <cite title="Source Title">{shopInfo.created_at}</cite>
                      </p>
                      <div className="row d-flex flex-row">
                        <div className="col d-flex flex-row-reverse">
                          <Link className="btn btn-success" to={`/shop/myshop`}>
                            View
                          </Link>
                        </div>
                        <div className="col">
              ...
              <>
                ...
                <Link className="card-body text-center" to={"/shop/add"}>
                  <blockquote className="blockquote mb-0 p-4  btn btn-light w-100 h-100">
                    <img
                      src={require("../assets/e-commerce.png")}
                      alt=""
                      width={"370px"}
                      srcSet=""
                    />
